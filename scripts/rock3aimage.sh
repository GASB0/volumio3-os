...
# TODO: Ask Matt about boot files
echo "Copying Volumio RootFs"
cp -pdR build/$ARCH/root/* /mnt/volumio/rootfs
echo "Copying rock3a boot files"
cp platform-rock3a/rock3a/boot/boot.ini* /mnt/volumio/rootfs/boot
cp platform-rock3a/rock3a/boot/meson8b_odroidc.dtb /mnt/volumio/rootfs/boot
cp platform-rock3a/rock3a/boot/uImage /mnt/volumio/rootfs/boot
echo "Copying rock3a modules and firmware"
# TODO: Ask Matt about this boards firmware and modules
